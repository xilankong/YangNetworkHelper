...
@interface YangHttpSessionManager : AFHTTPSessionManager <YangHttpClientProtocol>

@end

@implementation YangHttpSessionManager

@end

@interface YangHttpClient()  <YangHttpClientProtocol>
