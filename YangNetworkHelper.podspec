#
# Be sure to run `pod lib lint YangNetworkHelper.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'YangNetworkHelper/Classes/**/*'
  
  # s.resource_bundles = {
  #   'YangNetworkHelper' => ['YangNetworkHelper/Assets/*.png']
  # }
